  ...
  static toViewModel(raw: RawStartMetadata): MetadataModel {
    ...
    const model = {
      ...
      defaultValues: {
        ...
        meta: {
          name: raw?.name?.default || "demo",
          group: raw?.groupId?.default || "com.example",
          artifact: raw?.artifactId?.default || "demo",
          packageName: raw?.packageName?.default || "com.example.demo",
          packaging: raw?.packaging?.default || "jar",
          java: raw?.javaVersion?.default || "21",
          configurationFileFormat: raw?.configurationFileFormat?.default || "properties",
        },
      },
    };
